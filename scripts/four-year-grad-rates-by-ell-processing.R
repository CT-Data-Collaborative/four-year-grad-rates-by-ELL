...
four_yr_gr$`English Learner Status`[four_yr_gr$`English Learner Status` == "ELL"] <- "English Language Learner"
four_yr_gr$`English Learner Status`[four_yr_gr$`English Learner Status` == "Non-ELL"] <- "Non-English Language Learner"
...
backfill_years <- expand.grid(
  ...
  `English Learner Status` = unique(four_yr_gr$`English Learner Status`),
  `Year` = years
)
